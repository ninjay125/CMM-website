    ...
    <div className="font-sans bg-white min-h-screen text-black px-6 py-12">
      <section className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg text-black leading-relaxed mb-10">
          ...
          <strong className="text-[#E50914]">valuable visibility</strong> — helping businesses get in front of the right people, at the right time, with the right message. Whether you&apo;re launching a startup, scaling a service, or just tired of the noise, we bring clarity, creativity, and connections that convert.
          <br />
          <br />
